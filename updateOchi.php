...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    $sql = "SELECT * FROM ochiprod WHERE id_produs=$id_produs";
    ...
    do {
        if ( empty($id_produs) || empty($tip) || empty($cantitate) || empty($nume)) {
            $errorMessage = "Toate campurile sunt necesare";
            break;
        }

        $sql = "UPDATE ochiprod " .
               "SET id_produs = '$id_produs', tip = '$tip', cantitate = '$cantitate', nume = '$nume' " .
        ...
        $successMessage = "Produs actualizat";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            <input type="hidden" value="<?php echo $id_produs;?>">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="w3-button w3-deep-orange" href="seturi.php" role="button">Anuleaza</a>
                </div>
            </div>
        </form>
    </div>
